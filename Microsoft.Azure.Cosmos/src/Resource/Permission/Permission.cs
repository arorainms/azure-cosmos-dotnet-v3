...
namespace Microsoft.Azure.Cosmos
{
    ...
    public abstract class Permission
    {
        ...
        /// </summary>
        /// <param name="tokenExpiryInSeconds">(Optional) The expiry time for resource token in seconds. This value can range from 10 minues (or 600 seconds), to 24 hours (or 86,400 seconds). The default value for this is 1 hour (or 3,600 seconds). This does not change the default value for future tokens.</param>
